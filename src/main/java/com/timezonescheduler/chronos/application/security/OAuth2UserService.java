...
import com.timezonescheduler.chronos.application.security.oauth.user.OAuth2UserInfoFactory;
...
public class OAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        Optional<User> userOptional = userRepo.findUserByEmail(oAuth2UserInfo.getEmail());
        User user;
